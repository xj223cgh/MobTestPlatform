...
面向移动端测试团队的综合测试管理平台，覆盖用例管理（含 AI 生成）、用例评审、设备管理、测试任务执行、报告管理及消息通知等完整测试流程。通过浏览器访问管理端，适合多人协作与多项目并行。
...
| **报告管理** | 按任务聚合结果、自动 / 手动生成测试报告、导出 Word / Excel |
| **项目管理** | 项目创建与维护、成员管理、迭代规划与状态追踪 |
