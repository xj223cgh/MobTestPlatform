...
def register_blueprints(app):
    """注册蓝图"""
    from app.routes import auth, users, devices, test_cases, test_tasks, home, projects, iterations, test_suites, review_tasks, files, reports, settings_routes, ai_tasks, notifications, roles, mindmap, agent_routes, api_docs, knowledge
