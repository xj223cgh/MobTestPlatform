            ...
            <el-form :model="storageSettings" label-width="120px">
              ...
              <template v-if="storageSettings.type === 'oss'">
                <el-form-item label="AccessKey ID">
                  <el-input v-model="storageSettings.ossAccessKeyId" placeholder="请输入AccessKey ID" />
                </el-form-item>
                ...
                <el-form-item label="Endpoint">
                  <el-input v-model="storageSettings.ossEndpoint" placeholder="请输入Endpoint" />
                </el-form-item>
              ...
              <template v-if="storageSettings.type === 's3'">
                <el-form-item label="Access Key ID">
                  <el-input v-model="storageSettings.s3AccessKeyId" placeholder="请输入Access Key ID" />
                </el-form-item>
                ...
                <el-form-item label="Region">
                  <el-input v-model="storageSettings.s3Region" placeholder="请输入Region" />
                </el-form-item>
                <el-form-item label="Bucket">
                  <el-input v-model="storageSettings.s3Bucket" placeholder="请输入Bucket名称" />
                </el-form-item>
              </template>
