...
// 创建测试用例执行环境变量
export const createTestCaseExecutionEnvironmentVariable = (environmentId, data) => {
  return request({
    url: `/test-cases/executions/environments/${environmentId}/variables`,
    method: 'post',
    data
...
// 更新测试用例执行环境变量
export const updateTestCaseExecutionEnvironmentVariable = (environmentId, variableId, data) => {
  return request({
...
// 删除测试用例执行环境变量
export const deleteTestCaseExecutionEnvironmentVariable = (environmentId, variableId) => {
  return request({
    url: `/test-cases/executions/environments/${environmentId}/variables/${variableId}`,
    method: 'delete'
  })
